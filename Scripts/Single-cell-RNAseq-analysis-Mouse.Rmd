...
test <- GetAssayData(seurat_objectfiltered)
...
pred.test <- SingleR(test = single.sce, ref = MouseRNAseqData, labels = MouseRNAseqData$label.main)

seurat_objectfiltered[["MouseRNAseq"]] <- pred.test$labels
...
Idents(seurat_objectfiltered) <- seurat_objectfiltered$MouseRNAseq
...
m_df1 = msigdbr(species = "Mus musculus", category = "C2")
m_df2 = msigdbr(species = "Mus musculus", category = "C5")
